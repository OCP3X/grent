 ...
 */
class getDocumentiRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DocumentiRepository' shared autowired service.
     *
     * @return \App\Repository\DocumentiRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DocumentiRepository.php';

        return $container->privates['App\\Repository\\DocumentiRepository'] = new \App\Repository\DocumentiRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
