 ...
 */
class getVeicoliRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VeicoliRepository' shared autowired service.
     *
     * @return \App\Repository\VeicoliRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VeicoliRepository.php';

        return $container->privates['App\\Repository\\VeicoliRepository'] = new \App\Repository\VeicoliRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
