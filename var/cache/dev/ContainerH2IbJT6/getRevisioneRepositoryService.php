 ...
 */
class getRevisioneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RevisioneRepository' shared autowired service.
     *
     * @return \App\Repository\RevisioneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RevisioneRepository.php';

        return $container->privates['App\\Repository\\RevisioneRepository'] = new \App\Repository\RevisioneRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
