...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\WebuserCrudController' => 'getWebuserCrudControllerService',
            'App\\Controller\\DocumentiController' => 'getDocumentiControllerService',
            'App\\Controller\\LavagnaController' => 'getLavagnaControllerService',
            'App\\Controller\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\MainPage' => 'getMainPageService',
            'App\\Controller\\RegistrationController' => 'getRegistrationControllerService',
            'App\\Controller\\RevisioneController' => 'getRevisioneControllerService',
            'App\\Controller\\RigheController' => 'getRigheControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\StartController' => 'getStartControllerService',
            'App\\Controller\\TesteController' => 'getTesteControllerService',
            'App\\Controller\\VeicoliController' => 'getVeicoliControllerService',
            'App\\Controller\\VeicoliInfoController' => 'getVeicoliInfoControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NHq8HHpAV8', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J80R79s3b+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ej5RpnlYTh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\DocumentiRepository' => ['privates', 'App\\Repository\\DocumentiRepository', 'getDocumentiRepositoryService', true],
            'App\\Repository\\LavagnaRepository' => ['privates', 'App\\Repository\\LavagnaRepository', 'getLavagnaRepositoryService', true],
            'App\\Repository\\OffInterventoRepository' => ['privates', 'App\\Repository\\OffInterventoRepository', 'getOffInterventoRepositoryService', true],
            'App\\Repository\\PagamentiRepository' => ['privates', 'App\\Repository\\PagamentiRepository', 'getPagamentiRepositoryService', true],
            'App\\Repository\\RevisioneRepository' => ['privates', 'App\\Repository\\RevisioneRepository', 'getRevisioneRepositoryService', true],
            'App\\Repository\\RigheRepository' => ['privates', 'App\\Repository\\RigheRepository', 'getRigheRepositoryService', true],
            'App\\Repository\\TesteRepository' => ['privates', 'App\\Repository\\TesteRepository', 'getTesteRepositoryService', true],
            'App\\Repository\\VeicoliInfoRepository' => ['privates', 'App\\Repository\\VeicoliInfoRepository', 'getVeicoliInfoRepositoryService', true],
            'App\\Repository\\VeicoliRepository' => ['privates', 'App\\Repository\\VeicoliRepository', 'getVeicoliRepositoryService', true],
            'App\\Repository\\WebuserRepository' => ['privates', 'App\\Repository\\WebuserRepository', 'getWebuserRepositoryService', true],
        ], [
            'App\\Repository\\DocumentiRepository' => '?',
            'App\\Repository\\LavagnaRepository' => '?',
            'App\\Repository\\OffInterventoRepository' => '?',
            'App\\Repository\\PagamentiRepository' => '?',
            'App\\Repository\\RevisioneRepository' => '?',
    ...
    protected function getAdminUrlGeneratorService()
    {
        $this->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator'] = function () {
            return new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator(($this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? $this->getAdminContextProviderService()), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\DashboardControllerRegistry'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Registry\DashboardControllerRegistry($this->targetDir.'', ['App\\Controller\\Admin\\DashboardController' => '01d6cf2'], ['01d6cf2' => 'App\\Controller\\Admin\\DashboardController'])));
        };
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BdapeWQZGU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3V7TMsYzOO', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Eec8my9SGq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vYAABRYs89', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sUkMeVKT4h', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jiICkNjfGw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RquGT+obQt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
